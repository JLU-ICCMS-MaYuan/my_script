...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--end_pop_idxes", type=int, required=True, nargs="+", help="要读取的 dyn 文件的代编号, 比如你要提取ensembles中编号为1-25的npy数据就写-i 1 25. ")
    
    args = parser.parse_args()
    
    NQIRR = args.nqirr
    END_POP_IDXES = args.end_pop_idxes
    for END_POP_IDX in END_POP_IDXES:
        DYN_POP_IDX = END_POP_IDX -1 # 这是因为你属于的编号是动力学矩阵的编号，不是直接获得ensembles里面各个文件的编号
