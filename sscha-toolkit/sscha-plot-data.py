...
'''
    ...
    if plot_minim:
        ...
        fig_data.savefig("minimization_plot.png", dpi=DPI, bbox_inches="tight")
        print("Minimization plot saved as minimization_plot.png")
    ...
    if plot_frequencies:
        ...
        fig_freqs.savefig("frequencies_plot.png", dpi=DPI, bbox_inches="tight")
        print("Frequencies plot saved as frequencies_plot.png")
