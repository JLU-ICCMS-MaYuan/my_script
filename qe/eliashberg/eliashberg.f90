...
program main
  ...
  dw=(w(ndos)-w(1))/dble(ndos)
  ! compute the McMillan parameters
  call mcmillan(w,a2f,lambda,wlog,wrms,tc,ndos)
  write(6,'("McMillan equation: lamba =",f10.5,2x,"wlog =",f10.5,2x,"Tc =",f10.5)') lambda, wlog*3.158d05, tc
