...
if __name__ == "__main__":
    ...
    for NumberOfAtom, Volume in zip(NumberOfAtoms, Volumes):
        ...
        os.system(f"cp vasp.pbs  {calypso_path}")
        os.system(f"cp batchsubmit.sh  {calypso_path}")

    with open("fixed_comp.name", 'w') as f:
        f.writelines(calypso_paths)


    batchsubmit_sh_info = """#!/bin/bash
...
"""
    ...
    print("\n\nMaybe you need batchsubmit.sh\n\n")
    print(batchsubmit_sh_info)