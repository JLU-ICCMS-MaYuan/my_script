...
def set_Debye_frequency(phonondos, num_atoms, freq_max_fit=None):
    ...
    print("_freq_Debye", _freq_Debye*cm_1toThz)  
    print("_temperture_Debye", _freq_Debye*cm_1toKelvin)

if __name__ == "__main__":

    print("Note: --------------------")
    print("   get_debye_fromqe.py [dosfile] [atom_num_in_a_cell] [max_frequency]")
