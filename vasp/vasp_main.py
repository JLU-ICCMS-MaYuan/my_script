...
'''
vasp_main.py -i ./test/POSCAR          -w ./test/ -j pbs -p 200 relax      -m  mode=rv3
vasp_main.py -i ./test/POSCAR          -w ./test/ -j pbs -p 200 relax      -m  encut=400 kspacing=0.3 mode=rvf
vasp_main.py -i ./test/POSCAR          -w ./test/ -j pbs -p 200 phono      -m  supercell=[2,2,2] kpoints=[40,40,40] mode=disp   
vasp_main.py -i ./test/POSCAR          -w ./test/ -j pbs -p 200 phono      -m  supercell=[2,2,2] kpoints=[40,40,40] mode=dfpt
