...
class vasp_writesubmit:
    ...
    def slurmFopt(self, slurm_dirpath):
        ...
        with open(slurm_script_filepath, "w") as slurm:
            ...
            slurm.write('        sleep 3                                                          \n')                                                                         
            slurm.write('        timeout 14400s mpirun -n 48 /work/software/vasp.6.1.0/vasp_std  > vasp.log 2>&1 \n')                                                                         
    ...
    def slurm3opt(self, slurm_dirpath):
        ...
        with open(slurm_script_filepath, "w") as slurm:
            ...
            slurm.write("killall -9 vasp_std                   \n")
            slurm.write("sleep 3                               \n")
            slurm.write("timeout 14400s mpirun -np 48 /work/software/vasp.6.1.0/vasp_std > vasp.log_${i} 2>&1\n")
    ...
    def pbsFopt(self, pbs_dirpath):
        ...
        with open(pbs_script_filepath, "w") as pbs:
            ...
            pbs.write("        sleep 3                                                                     \n")
            pbs.write('        timeout 14400s mpirun -n 28 /public/home/mayuan/software/vasp.6.1.0/bin/vasp_std  > vasp.log 2>&1  \n')                        
    ...
    def pbs3opt(self, pbs_dirpath):
        ...
        with open(pbs_script_filepath, "w") as pbs:
            ...
            pbs.write("killall -9 vasp_std                                                                             \n")
            pbs.write("sleep 3                                                                                         \n")
            pbs.write("timeout 14400s mpirun -np  28 /public/home/mayuan/software/vasp.6.1.0/bin/vasp_std > vasp.log_${i} 2>&1\n")
