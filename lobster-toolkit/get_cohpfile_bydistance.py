...
parser.add_argument('-m', '--mode', choices=['5', '0'], required=True, help="选择生成的输入文件版本：'5' 或 '0'")
...
def write_lobsterin(dirname, mode=5):
    if mode == 5:
        with open(dirname+"/lobsterin", "w") as f:
...
write_lobsterin(dirs, mode=mode)
